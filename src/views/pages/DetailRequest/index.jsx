  ...
  return (
    <div className="main-wrapper">
          ...
          <div className="container-post-b">
            <div className="header-post-b">
              <div className="user-info-b">
                <Image
                  src={request.author.avatar_file?.url || noAvt}
                  className="user-avatar-b"
                />
                <div className="user-name-b">
                  <Text>{request.author.display_name}</Text>
                </div>
                <Text className="post-time-b">{request.created_at}</Text>
              </div>
            </div>
            <div className="post-body-b">
              <Text className="post-content-b">{request.content}</Text>
              {request.files && request.files.length > 0 && (
                <Box className="post-image-b">
                  <ImageList files={request.files} isEditable={false} />
                </Box>
              )}
            </div>
          </div>
      ...
      <div className="footer-main">
        ...
        >
          <LeftOutlined style={{ fontSize: "12px", marginRight: "4px" }} />
          Quay lại
        </Button>
