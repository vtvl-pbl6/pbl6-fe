import { Avatar, Box, Flex, Menu, MenuButton, MenuItem, MenuList, Text, VStack } from "@chakra-ui/react"
        ...
        <Flex justifyContent={"space-between"} width={"full"} >
            <Box>
                ...
                <Flex gap={2} alignItems={"center"}>
                    ...
                    <Text fontSize={"small"} bg={"gray.dark"} color={"gray.light"} padding={1} borderRadius={"full"}>
                        threads.net
                    </Text>
            ...
            <Box>
                <Avatar name="Mark Zuckerberg" src="/mark.png" size={{
                    base: "md", md: "lg"
                }
                }/>
            </Box>
